...
#### Prepare your attestations file content. (See [attestation sample template](https://github.com/cmsgov/cms-ars-3.1-moderate-manual-controls-overlay/blob/update/attestation-template-cms-ars-3.1-manual-controls-baseline.json))
...
```
# How to run
cinc-auditor exec https://github.com/cmsgov/cms-ars-3.1-moderate-manual-controls-overlay/archive/main.tar.gz --reporter hdf:<path_to_your_output_file/name_of_your_output_file.json> --config <path_to_your_attestation_file/name_of_your_attestation_file.json>
```
...
mkdir profiles
cd profiles
git clone https://github.com/cmsgov/cms-ars-3.1-moderate-manual-controls-overlay.git
...
To report a bug or feature request, please open an [issue](https://github.com/cmsgov/cms-ars-3.1-moderate-manual-controls-overlay/issues/new).
